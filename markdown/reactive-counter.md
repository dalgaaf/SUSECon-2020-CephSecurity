<!-- .slide: data-state="section-break" id="section-break-5" data-timing="10s" data-background-image="images/susecon_background_full.svg" data-background-size="auto 100%" -->
